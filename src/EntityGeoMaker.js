...
export default class EntityGeoMaker {
    ...
    async entityModelToCubes(entityModelInfo) {
        // 🔹 Override identifier to leash_knot if it was armor_stand
        if(entityModelInfo["identifier"] === "minecraft:armor_stand") {
            entityModelInfo["identifier"] = "minecraft:leash_knot";
        }
        ...
        let matchingGeo = geoFile["minecraft:geometry"].find(
            geo => geo["description"]["identifier"] == entityModelInfo["identifier"]
        );
